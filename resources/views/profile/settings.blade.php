...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <a href="{{ route("settings.edit-profil") }}">
    <div class="border-b border-gray-300 px-4 py-5 sm:p-0 flex items-center gap-3">
      <svg xmlns="http://www.w3.org/2000/svg" class="left-10 w-4 h-4" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>
      <h2 class="text-sl leading-6 font-medium text-gray-900">Profil</h2>
    </div>
    </a>
    <div class="border-b border-gray-300 px-4 py-5 sm:p-0 flex items-center gap-3">
      ...
      <h2 class="text-sl leading-6 font-medium text-gray-900">Notifications</h2>
    </div>
    <div class="border-b border-gray-300 px-4 py-5 sm:p-0 flex items-center gap-3">
      ...
      <h2 class="text-sl leading-6 font-medium text-gray-900">Mes promotions</h2>
    </div>
    <div class="border-b border-gray-300 px-4 py-5 sm:p-0 flex items-center gap-3">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M256 0c4.6 0 9.2 1 13.4 2.9L457.7 82.8c22 9.3 38.4 31 38.3 57.2c-.5 99.2-41.3 280.7-213.6 363.2c-16.7 8-36.1 8-52.8 0C57.3 420.7 16.5 239.2 16 140c-.1-26.2 16.3-47.9 38.3-57.2L242.7 2.9C246.8 1 251.4 0 256 0z"/></svg>
      <h2 class="text-sl leading-6 font-medium text-gray-900">Modes de paiement</h2>
    </div>
    <div class="border-b border-gray-300 px-4 py-5 sm:p-0 flex items-center gap-3">
      ...
      <h2 class="text-sl leading-6 font-medium text-gray-900">Langue</h2>
    </div>
    <div class="border-b border-gray-300 px-4 py-5 sm:p-0 flex items-center gap-3">
      ...
      <h2 class="text-sl leading-6 font-medium text-gray-900">Accessibilité</h2>
    </div>
    @endsection
    </body>
</html>
