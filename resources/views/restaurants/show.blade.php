...
@section('content')
  ...
  <div class="bg-white border-t border-gray-300 mb-5">
    <div class="  items-center px-4 py-10">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Commentaires</h1>
          ...
          <div class="w-full mx-auto border-b border-gray-300 px-6 py-4 ">
            <div class="flex items-center mb-6">
                ...
                <div>
                    ...
                    <div class="text-gray-500">{{ $date[0] }}</div>
                    <div class="text-dinee flex items-center" >
                      @for ($i = 0; $i < $review->stars; $i++)
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="#60EE96" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>
                      @endfor
