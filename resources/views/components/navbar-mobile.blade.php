...
<div class="fixed bottom-0 left-0 right-0 bg-dinee shadow-lg z-50">
  <div class="relative flex justify-between items-center px-6 py-6">
    <!-- Home -->
    <a href="{{ route('home') }}" class="flex flex-col items-center text-white {{ request()->routeIs('home') ? 'scale-150' : ''}} transition-normal">
    ...
    <!-- Heart -->
    <a href="{{ route('restaurants') }}" class="flex flex-col items-center text-white {{ request()->routeIs('restaurants') ? 'scale-150' : ''}} transition-normal">
    ...
    <!-- Cart -->
    <a href="{{ route('cart.index') }}" class="flex flex-col items-center text-white {{ request()->routeIs('cart.index') ? 'scale-150' : ''}} transition-normal">
    ...
    <!-- Profile -->
    <a href="{{ route('profil') }}" class="flex flex-col items-center text-white {{ request()->routeIs('profil') ? 'scale-150' : ''}} transition-normal">
